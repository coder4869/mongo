...
mkdir -p ~/Desktop/mongodb3.2.6 # not MONGO_HOME dir
tar -zxvf ~/Desktop/mongodb-linux-x86_64-3.2.6.tgz -C ~/Desktop/mongodb3.2.6/
...
mkdir -p ${MONGO_HOME}
cp -rf ~/Desktop/mongodb3.2.6/mongodb-linux-x86_64-3.2.6/* ${MONGO_HOME}
